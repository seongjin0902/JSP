	...
	<div class="bigbox">
		...
		<div class="box">
			...
			<form action="register.do" method="post">
				<div class="idbox">
					<input id="id" name="id" required placeholder="아이디" /> 
					<button id="checkDuplicateBtn" type="button">중복 체크</button>
					<div id="idErrorMsg" style="color: red;"></div>
				...
				<div class="namebox">
					...
					<input name="phone" value="010-" required /> 
	    ...
	    $("#checkDuplicateBtn").on("click", function() {
	      ...
	      $.ajax({
	        ...
	        success: function(data) {
	          if (data === "duplicate") {
	            $("#idErrorMsg").text("이미 사용 중인 아이디입니다.");
	          } else {
	            $("#idErrorMsg").text("사용 가능한 아이디입니다.");
	          }
	        },
	        error: function() {
	          $("#idErrorMsg").text("서버와 통신 중 오류가 발생했습니다.");
	        }
	      });
	    });
	  });
